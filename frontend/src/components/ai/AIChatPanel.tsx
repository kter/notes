  ...
  return (
    <div className="flex h-full">
      ...
      <div className="p-4 border-b border-border/50">
        ...
        {/* Mode Toggle */}
        {onToggleEditMode && (
          <div className="flex rounded-lg border border-border/50 p-0.5 mb-3" data-testid="mode-toggle">
            <button
              className={cn(
        ...
        {/* Scope Selector - hidden in edit mode */}
        {!isEditMode && (
      ...
      <ScrollArea className="flex-1 min-h-0 p-4" ref={scrollRef}>
        <div className="space-y-4">
          {/* Edit mode: no note selected warning */}
          ...
          {messages.length === 0 && (!isEditMode || selectedNote) ? (
            <div className="text-center py-12 px-4">
              ...
              <p className="text-sm font-medium mb-1">
                {isEditMode ? t("aiEdit.edit") : t("ai.howCanIHelp")}
              </p>
      ...
      <div className="p-4 border-t border-border/50 bg-background/50 backdrop-blur-sm">
        <div className="flex gap-2 items-end bg-background rounded-xl border border-border p-2 focus-within:border-primary/50 transition-colors shadow-sm">
          <Textarea
            ...
            disabled={isLoading || (isEditMode && !selectedNote)}
          ...
          <Button
            ...
            onClick={handleSend}
            disabled={!input.trim() || isLoading || (isEditMode && !selectedNote)}
